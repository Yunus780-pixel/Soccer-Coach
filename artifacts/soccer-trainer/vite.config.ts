...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@mediapipe/pose": path.resolve(import.meta.dirname, "src/stubs/mediapipe-pose.ts"),
      "@tensorflow/tfjs-backend-webgpu": path.resolve(import.meta.dirname, "src/stubs/tfjs-backend-webgpu.ts"),
    },
